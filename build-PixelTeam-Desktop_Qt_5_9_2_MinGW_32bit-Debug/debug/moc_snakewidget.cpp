...
#include "../../PixelTeamFinalVertion/snakewidget.h"
...
QT_MOC_LITERAL(1, 12, 15), // "Backtomainscene"
QT_MOC_LITERAL(2, 28, 0) // ""

    },
    "SnakeWidget\0Backtomainscene\0"
};
...
void SnakeWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (SnakeWidget::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SnakeWidget::Backtomainscene)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SnakeWidget::Backtomainscene()
{
